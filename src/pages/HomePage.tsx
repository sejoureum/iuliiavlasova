...
> = {
  en: {
    ...
    eyebrow: 'Portfolio',
    title: "Hello, I'm Yulia — I design clear interfaces and visual stories.",
    lead: 'Browse sample work and get in touch to discuss your project — copy and contact details are easy to adapt.',
  ...
  fr: {
    ...
    eyebrow: 'Portfolio',
    title: 'Bonjour, je suis Ioulia — je conçois des interfaces claires et des récits visuels.',
    lead: 'Parcourez des exemples de travaux et contactez-moi pour parler de votre projet — les textes et coordonnées sont faciles à adapter.',
  ...
  ru: {
    ...
    eyebrow: 'Портфолио',
    title: 'Здравствуйте, я Юлия — проектирую понятные интерфейсы и визуальные истории.',
